...
{
    public partial class MSIStockStatus : Form
    {
        ...
        public MSIStockStatus()
        {
            InitializeComponent();
        }
        public MSIStockStatus(long vchType)
        {
            InitializeComponent();
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Convert.ToBoolean(ObjFunction.GetAppSettings(AppSettings.ReportDisplay)) == true)
                    NewF = new Display.ReportViewSource(new Reports.MSIStockStatus(), ReportSession);
                else
                    NewF = new Display.ReportViewSource(ObjFunction.LoadReportObject("MSIStockStatus.rpt", CommonFunctions.ReportPath), ReportSession);
