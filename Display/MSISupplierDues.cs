...
{
    public partial class MSISupplierDues : Form
    {
        ...
        public MSISupplierDues()
        {
            InitializeComponent();
        }
        public MSISupplierDues(long vchType)
        {
            InitializeComponent();
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ReportSession[1] = VchType.Purchase.ToString();
                ReportSession[2] = DBGetVal.FirmNo.ToString();
                Form NewF = null;
                if (Convert.ToBoolean(ObjFunction.GetAppSettings(AppSettings.ReportDisplay)) == true)
                    NewF = new Display.ReportViewSource(new Reports.MSISupplierDues(), ReportSession);
                else
                    NewF = new Display.ReportViewSource(ObjFunction.LoadReportObject("MSISupplierDues.rpt", CommonFunctions.ReportPath), ReportSession);
