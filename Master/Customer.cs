...
namespace Yadi.Master
{
    public partial class Customer : Form
    {
        ...
        public static long RequestCustomerNo,GroupNo;
        ...
        {
            GroupNo = (int)GroupType.SundryDebtors;
            
            CmbSearch.Items.Add(new Item("-----Select-----", "0"));
            CmbSearch.Items.Add(new Item("Customer Name", "LedgerName"));
            CmbSearch.Items.Add(new Item("Contact Person", "ContactPerson"));
            //CmbSearch.Items.Add(new Item("Customer. Short Code", "CustomerShortCode"));
        ...
        {
            RequestCustomerNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new CustomerAE();
            this.Close();
            ObjFunction.OpenForm(NewF, DBGetVal.MainForm);
        }
