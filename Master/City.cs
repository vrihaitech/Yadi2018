...
namespace Yadi.Master
{
    public partial class City : Form
    {
        ...
        public static long RequestCityNo;
        ...
        private void City_Load(object sender, EventArgs e)
        {
            ...
            CmbSearch.Items.Add(new Item("City Name", "CityName"));
            CmbSearch.Items.Add(new Item("City. Short Code", "CityShortCode"));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbCity.GetBySearch(itm.Value, TxtSearch.Text);
        ...
        {
            RequestCityNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new CityAE();
            this.Close();
