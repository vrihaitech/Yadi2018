...
namespace Yadi.Master
{
    public partial class Broker : Form
    {
        ...
        public static long RequestBrokerNo,GroupNo;
        ...
        {
            GroupNo = (int)GroupType.Broker;
            
            CmbSearch.Items.Add(new Item("-----Select-----", "0"));
            CmbSearch.Items.Add(new Item("Broker Name", "LedgerName"));
        ...
        {
            RequestBrokerNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new BrokerAE();
            this.Close();
            ObjFunction.OpenForm(NewF, DBGetVal.MainForm);
        }
