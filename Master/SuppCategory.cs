...
{
    public partial class SuppCategory : Form
    {
        CommonFunctions ObjFunction = new CommonFunctions();
        DBMSuppCategory dbSuppCategory = new DBMSuppCategory();
        public static long RequestSuppCategoryNo;
        ...
        private void SuppCategory_Load(object sender, EventArgs e)
        {
            
            CmbSearch.Items.Add(new Item("-----Select-----", "0"));
            CmbSearch.Items.Add(new Item("SuppCategory Name", "CategoryName"));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbSuppCategory.GetBySearch(itm.Value, TxtSearch.Text);
        ...
        {
            RequestSuppCategoryNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new SuppCategoryAE();
            this.Close();
