...
namespace Yadi.Master
{
    public partial class Qualification : Form
    {
        ...
        public static long RequestQualificationNo;
        ...
        private void Qualification_Load(object sender, EventArgs e)
        {
            ...
            CmbSearch.Items.Add(new Item("Qualification Name", "QualificationName"));
            CmbSearch.Items.Add(new Item("Qualification.Short Code", "ShortName"));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbQualification.GetBySearch(itm.Value, TxtSearch.Text);
        ...
        {
            RequestQualificationNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new QualificationAE();
            this.Close();
