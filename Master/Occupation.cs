...
namespace Yadi.Master
{
    public partial class Occupation : Form
    {
        ...
        public static long RequestOccupationNo;
        ...
        private void Occupation_Load(object sender, EventArgs e)
        {
            ...
            CmbSearch.Items.Add(new Item("Occupation Name", "OccupationName"));
            CmbSearch.Items.Add(new Item("Occupation.Short Code", "ShortName"));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbOccupation.GetBySearch(itm.Value, TxtSearch.Text);
        ...
        {
            RequestOccupationNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new OccupationAE();
            this.Close();
