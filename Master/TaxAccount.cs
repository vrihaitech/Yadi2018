...
{
    public partial class TaxAccount : Form
    {
        ...
        private void TaxAccount_Load(object sender, EventArgs e)
        {
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbLedger.GetBySearchTaxAcc(itm.Value, TxtSearch.Text);
