...
namespace Yadi.Master
{
    public partial class Country : Form
    {
        ...
        public static long RequestCountryNo;
        ...
        private void Country_Load(object sender, EventArgs e)
        {
            ...
            CmbSearch.Items.Add(new Item("Country Name", "CountryName"));
            CmbSearch.Items.Add(new Item("Country.Short Name", "CountryShortCode"));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbCountry.GetBySearch(itm.Value, TxtSearch.Text);
        ...
        {
            RequestCountryNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new CountryAE();
            this.Close();
