...
{
    public partial class FooterDiscoutSearch : Form
    {
        CommonFunctions ObjFunction = new CommonFunctions();
        DBMFooterDiscount dbFooter = new DBMFooterDiscount();
        public static long RequestFooterDiscNo,GroupNo;

        public FooterDiscoutSearch()
        {
            InitializeComponent();
        }
        ...
        private void Supplier_Load(object sender, EventArgs e)
        {
            ...
            CmbSearch.Items.Add(new Item("Doc No", "FooterDiscUserNo"));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbFooter.GetBySearch(itm.Value, TxtSearch.Text);
        ...
        {
            RequestFooterDiscNo = 0;
            Form NewF = new FooterDiscount();
            this.Close();
        ...
        {
            RequestFooterDiscNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new FooterDiscount();
            this.Close();
            ObjFunction.OpenForm(NewF, DBGetVal.MainForm);
        }
