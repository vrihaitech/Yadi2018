...
namespace Yadi.Master
{
    public partial class Firm : Form
    {
        ...
        public static long RequestMFirmNo;
        ...
        private void Firm_Load(object sender, EventArgs e)
        {
            ...
            CmbSearch.Items.Add(new Item("Name", "FirmName"));
            CmbSearch.Items.Add(new Item("Short Name", "ShortName"));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbmFirm.GetBySearch(itm.Value, TxtSearch.Text);
        ...
        {
            RequestMFirmNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new FirmAE();
            this.Close();
