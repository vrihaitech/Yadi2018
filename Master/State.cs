...

{
    public partial class State : Form
    {
        ...
        public static long RequestStateNo;
        ...
        private void State_Load(object sender, EventArgs e)
        {
            ...
            CmbSearch.Items.Add(new Item("State Name", "StateName"));
            CmbSearch.Items.Add(new Item("State. Short Name", "StateShortCode"));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbState.GetBySearch(itm.Value, TxtSearch.Text);
        ...
        {
            RequestStateNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new StateAE();
            this.Close();
