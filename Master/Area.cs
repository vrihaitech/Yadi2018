...
namespace Yadi.Master
{
    public partial class Area : Form
    {
        ...
        public static long RequestAreaNo;
        ...
        private void Area_Load(object sender, EventArgs e)
        {
            ...
            CmbSearch.Items.Add(new Item("Area Name", "AreaName"));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbArea.GetBySearch(itm.Value, TxtSearch.Text);
        ...
        {
            RequestAreaNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new AreaAE();
            this.Close();
