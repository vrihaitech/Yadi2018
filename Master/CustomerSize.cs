...
{
    public partial class CustomerSize : Form
    {
        CommonFunctions ObjFunction = new CommonFunctions();
        DBMCustomerSize dbCustomerSize = new DBMCustomerSize();
        public static long RequestCustomerSizeNo;
        ...
        private void CustomerSize_Load(object sender, EventArgs e)
        {
            
            CmbSearch.Items.Add(new Item("-----Select-----", "0"));
            CmbSearch.Items.Add(new Item("CustomerSize Name", "CustSizeName"));
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dv = dbCustomerSize.GetBySearch(itm.Value, TxtSearch.Text);
        ...
        {
            RequestCustomerSizeNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = new CustomerSizeAE();
            this.Close();
