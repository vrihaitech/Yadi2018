...
{
    public partial class BarcodePrintingPurchase : Form
    {
        ...
        public BarcodePrintingPurchase()
        {
            InitializeComponent();
        }
        public BarcodePrintingPurchase(DataTable tempdt)
        {
            InitializeComponent();

           // GridViewPur.Columns[8].DefaultCellStyle = System.Windows.Forms.DataGridView
            for (int i = 0; i <= tempdt.Rows.Count - 1; i++)
            {
                GridViewPur.Rows.Add();
                for (int j = 0; j < GridViewPur.Columns.Count; j++)
                {
                    GridViewPur.Rows[i].Cells[j].Value = tempdt.Rows[i].ItemArray[j].ToString();
                }
            }

        }

        public BarcodePrintingPurchase(long id, long ratesettingno, string mrp, string rate, string brand, string shortDesc, string barcode)
        {
            try
            {
                InitializeComponent();
        ...
        //public BarcodePrintingPurchase(DataTable dt)
        //{
        //    InitializeComponent();
        ...
        //        for (int j = 0; j < GridViewPur.Columns.Count; j++)
        //        {
        //            GridViewPur.Rows[i].Cells[j].Value = dt.Rows[i].ItemArray[j].ToString();
        //        }
        //    }
                ...
                if (Validation())
                {
                    ...
                    else
                    {
                       ...
                       // DBBarCodePrint dbBarcodePrint = new DBBarCodePrint();
                        ...
                        for (int j = 0; j < GridViewPur.Rows.Count; j++)
                        {
                            DBBarCodePrint dbBarcodePrint = new DBBarCodePrint();
                            BarCodePrint barcodeprint = new BarCodePrint();
                           ...
                           // for (int i = 0; i < GridView.Rows.Count; i++)
                            {   
                                ...
                                barcodeprint.VarBarCode = GridViewPur.Rows[j].Cells[9].Value.ToString();
                                ...
                                barcodeprint.VarMRP = (Convert.ToBoolean(GridView.Rows[1].Cells[5].FormattedValue) == true) ? GridViewPur.Rows[j].Cells[2].Value.ToString() : "";
                                barcodeprint.VarRate = (Convert.ToBoolean(GridView.Rows[2].Cells[5].FormattedValue) == true) ? GridViewPur.Rows[j].Cells[3].Value.ToString() : "";
                                ...
                                barcodeprint.VarBrand = (Convert.ToBoolean(GridView.Rows[4].Cells[5].FormattedValue) == true) ? GridViewPur.Rows[j].Cells[1].Value.ToString() : "";
                                barcodeprint.VarShortDesc = (Convert.ToBoolean(GridView.Rows[5].Cells[5].FormattedValue) == true) ? GridViewPur.Rows[j].Cells[10].Value.ToString() : "";
                                ...
                                barcodeprint.VarFreeText1 = (Convert.ToBoolean(GridView.Rows[9].Cells[5].FormattedValue) == true) ? GridViewPur.Rows[j].Cells[10].Value.ToString() : "";
                                barcodeprint.VarFreeText2 = (Convert.ToBoolean(GridView.Rows[8].Cells[5].FormattedValue) == true) ? GridView.Rows[9].Cells[4].Value.ToString() : "";
                                ...
                                barcodeprint.VarQuantity =Convert.ToInt32( Convert.ToDouble(GridViewPur.Rows[j].Cells[6].Value.ToString()));
        ...
        private void btnOKPur_Click(object sender, EventArgs e)
        {
            pnlMainPur.Visible = true;
        ...
        private void GridViewPur_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            if (e.ColumnIndex == 0)
            {
                e.Value = (e.RowIndex + 1).ToString();
        ...
        private void btnExitPur_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        private void GridViewPur_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Enter)
                {
                    if (GridViewPur.Rows.Count == GridViewPur.CurrentCell.RowIndex)
                    {
                        btnOKPur.Focus();
                    }
        ...
        private void GridViewPur_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (GridViewPur.CurrentCell.ColumnIndex == 6)
                {
                    // gBill.Rows[dgBill.CurrentCell.RowIndex].Cells[ColIndex.PkStockTrnNo].Value 

                    GridViewPur.Rows[GridViewPur.CurrentCell.RowIndex].Cells[8].Value = true;
                }
        ...
        private void pnlPur_Paint(object sender, PaintEventArgs e)
        {
