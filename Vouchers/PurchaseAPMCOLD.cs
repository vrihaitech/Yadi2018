...
{
    public partial class PurchaseAPMCOLD : Form
    {
        ...
        public PurchaseAPMCOLD()
        {
            InitializeComponent();
        }

        public PurchaseAPMCOLD(long ID)
        {
            InitializeComponent();
            this.ID = ID;
        }
        ...
        public void FillList()
        {
            ...
            Companycode = ObjQry.ReturnLong("select Statecode from Mcompany ", CommonFunctions.ConStr);
            ...
            try
            {
                ...
                if (State == true)
                {
                    sqlQuery = "SELECT 0 AS Sr,(SELECT case when esflag='False' then ItemName else ItemName+'*' end as ItemName FROM dbo.MStockItems_V(NULL, TStock.ItemNo, NULL, NULL, NULL, NULL, NULL) AS MStockItems_V_1) AS ItemName, TStock.Quantity, MUOM.UOMName, " +
                            ...
                            " TStock.Rate as TempRate,IsNull(TOtherStockDetails.FKOtherVoucherNo,0) As PONo, IsNull(TOtherStockDetails.PkSrNo,0) As PKStockOtherDetailsNo,IsNull(TOtherStockDetails.FKOtherStockTrnNo,0) AS FKOtherStockTrnNo ,0 as FreeQty ,'' as FreeUomName,0 as BarcodePrinting,0 as FreeUomNo,0 as LandedRate ,0 as Charg,MItemMaster.ESFlag," +
                            " TStock.Remarks,TStock.GRWeight,TStock.TRWeight,TStock.Freight,TStock.OtherCharges " +
            ...
            if (e.KeyChar == Convert.ToChar(Keys.Enter))
            {
                ...
                else
                {
                    ...
                    if (ObjQry.ReturnLong(" Select Count(*) FROM  TVoucherEntry  where TVoucherEntry.Reference ='" + txtRefNo.Text.Trim() + "' and TVoucherEntry.VoucherTypeCode=" + VoucherType + " " +
                                         ...
                                         " and TVoucherEntry.PkVoucherNo!=" + ID + " AND TVoucherEntry.BrokerNo=0", CommonFunctions.ConStr) > 0)//TVoucherEntry.VoucherDate='" + Convert.ToDateTime(dtpBillDate.Text).ToString("dd-MMM-yyyy") + "' and 
                    {
        ...
        private void btnGOk_Click(object sender, EventArgs e)
        {
            ...
            if (dtRateSetting.Rows.Count > 0 && txtBarCode.Text != "")
            {
                ...
                if (qty == false)
                {
                    ...
                    dgBill.CurrentRow.Cells[ColIndex.SGSTPercentage2].Value = txtBTaxPer2.Text = dtRateSetting.Rows[1]["Percentage"].ToString();
        ...
        public static class ColIndex
        {
            ...
            public static int PkVoucherNo = 16;
            public static int ItemNo = 17;
            public static int UOMNo = 18;
            public static int PkRateSettingNo = 19;
            public static int MRP = 20;
            public static int StockFactor = 21;
            public static int ActualQty = 22;
            public static int MKTQuantity = 23;

            public static int SGSTPercentage = 24;
            public static int SGSTAmount = 25;
            public static int TaxLedgerNo = 26;
            public static int SalesLedgerNo = 27;
            public static int PkItemTaxInfo = 28;
            public static int SalesVchNo = 29;
            public static int TaxVchNo = 30;

            public static int SGSTPercentage2 = 31;
            public static int SGSTAmount2 = 32;
            public static int TaxLedgerNo2 = 33;
            public static int SalesLedgerNo2 = 34;
            public static int PkItemTaxInfo2 = 35;
            public static int SalesVchNo2 = 36;
            public static int TaxVchNo2 = 37;

            public static int SGSTPercentage3 = 38;
            public static int SGSTAmount3 = 39;
            public static int TaxLedgerNo3 = 40;
            public static int SalesLedgerNo3 = 41;
            public static int PkItemTaxInfo3 = 42;
            public static int SalesVchNo3 = 43;
            public static int TaxVchNo3 = 44;


            public static int StockCompanyNo = 45;
            ...
            public static int Charg = 57;

            public static int ESFlag = 58;
            public static int Remarks = 59;
        ...
        private void BindGrid(int RowIndex)
        {
            try
            {
                ...
                //    " t.PkSrNo,t.Percentage,cast(r.MRP as numeric(18,2)) as MRP FROM MRateSetting As r,GetItemTaxAll(" + ItemNo + ", '" + dtpBillDate.Value.ToString("dd-MMM-yyyy") + " " + DBGetVal.ServerTime.ToLongTimeString() + "', " + GroupType.SalesAccount + "," + TaxTypeNo  + ",NULL) As t " +
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (State == true)
                    {
                        ...
                        dgBill.Rows[RowIndex].Cells[ColIndex.SGSTPercentage2].Value = Convert.ToDouble(dt.Rows[1][6].ToString());
                    ...
                    else
                    {
                        ...
                        dgBill.Rows[RowIndex].Cells[ColIndex.SGSTPercentage2].Value = 0;
                    }
                   ...
                   " WHERE r.PkSrNo = " + RateSettingNo + " AND r.ItemNo = t.ItemNo").Table;
                    if (dtAddtionalTax.Rows.Count > 0)
                    {
                        ...
                        dgBill.Rows[RowIndex].Cells[ColIndex.SGSTPercentage3].Value = Convert.ToDouble(dtAddtionalTax.Rows[0][6].ToString());
                    ...
                    else
                    {
                        ...
                        dgBill.Rows[RowIndex].Cells[ColIndex.SGSTPercentage3].Value = 0;
...

                {
                    for (int i = 0; i < dgBill.Rows.Count; i++)
                    {
                        if (dgBill.Rows[i].Cells[ColIndex.ItemNo].Value != null && dgBill.Rows[i].Cells[ColIndex.ItemNo].Value.ToString() != "")
                        {
                            ...
                            TaxPerce2 = Convert.ToDouble(dgBill.Rows[i].Cells[ColIndex.SGSTPercentage2].Value);
                            TaxPerce3 = Convert.ToDouble(dgBill.Rows[i].Cells[ColIndex.SGSTPercentage3].Value);
                            ...
                            else
                            {
                                ...
                                TaxAmt = Math.Round(Convert.ToDouble((tAmount * SubTax1) / 100), 2);
                            ...
                            dgBill.Rows[i].Cells[ColIndex.SGSTAmount2].Value = TaxAmt2.ToString("0.00");
        ...
        private void CalculateSubTotal()
        {
            ...
            SubTax2 = Convert.ToDouble((txtBTaxPer2.Text == "") ? "0" : txtBTaxPer2.Text);// Convert.ToDouble(dgBill.CurrentRow.Cells[ColIndex.SGSTPercentage2].Value);
            ...
            for (int i = 0; i < dgBill.Rows.Count - 1; i++)
            {
                if (Convert.ToBoolean(dgBill.Rows[i].Cells[ColIndex.ESFlag].Value.ToString()) == false)
                {
                    ...
                    if (Convert.ToBoolean(ObjFunction.GetAppSettings(AppSettings.P_IsReverseRateCalc)) == false)
                        PBillTotal = PBillTotal + Convert.ToDouble(dgBill.Rows[i].Cells[ColIndex.Amount].Value) + Convert.ToDouble(dgBill.Rows[i].Cells[ColIndex.SGSTAmount].Value) + Convert.ToDouble(dgBill.Rows[i].Cells[ColIndex.SGSTAmount2].Value) + Convert.ToDouble(dgBill.Rows[i].Cells[ColIndex.SGSTAmount3].Value);
                    else
            ...
            try
            {
                ...
                for (int i = 0; i < dgBill.Rows.Count - 1; i++)
                {
                    if (Convert.ToInt64(dgBill[ColIndex.StockCompanyNo, i].Value.ToString()) == DBGetVal.FirmNo)//Convert.ToInt64(dtCompRatio.Rows[j].ItemArray[0].ToString())
                    {
                        ...
                        tStock.GRWeight = (Convert.ToDouble(dgBill[ColIndex.GRWeight, i].Value.ToString()) == 0) ? 0.00 : Convert.ToDouble(dgBill[ColIndex.GRWeight, i].Value.ToString());
                        tStock.TRWeight = Convert.ToDouble(dgBill[ColIndex.TRWeight, i].Value.ToString());

                        tStock.Freight = Convert.ToDouble(dgBill[ColIndex.Freight, i].Value.ToString());
                        ...
                        if (State == true)
                        {
                            ...
                            tStock.FkItemTaxInfo = Convert.ToInt64(dgBill[ColIndex.PkItemTaxInfo, i].Value.ToString());
                            tStock.CGSTPercentage = Convert.ToDouble(dgBill[ColIndex.SGSTPercentage2, i].Value.ToString());
                            tStock.CGSTAmount = Convert.ToDouble(dgBill[ColIndex.SGSTAmount2, i].Value.ToString());
                ...
                if (DBGetVal.KachhaFirm == false)
                {
                    ...
                    for (int k = 0; k < dtTAxLedger.Rows.Count; k++)
                    {
                        ...
                        for (int j = 0; j < dgBill.Rows.Count - 1; j++)
                        {
                            ...
                            {
                                if (cntTaxLedg == -1) cntTaxLedg = j;
                                debit = debit + Convert.ToDouble(dgBill.Rows[j].Cells[ColIndex.SGSTAmount2].Value);
                ...
                if (Convert.ToDouble(txtChrgRupees1.Text) != 0)
                {
                    ...
                    tVoucherDetails.Debit = Convert.ToDouble(txtChrgRupees1.Text);
        ...
        private void dgBill_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (dgBill.Rows[dgBill.CurrentCell.RowIndex].Cells[ColIndex.PkStockTrnNo].Value.ToString() != "0")//&& Convert.ToBoolean(ObjFunction.GetAppSettings(AppSettings.P_AfterSaveNotDeleteItem)) == true)
                    {
                        e.SuppressKeyPress = true;
                        dgBill.CurrentCell = dgBill[dgBill.CurrentCell.ColumnIndex, dgBill.CurrentCell.RowIndex];
                        dgBill.Focus();
