...
{
    public partial class PartialPurchasePayment : Form
    {
        ...
        public PartialPurchasePayment()
        {
            InitializeComponent();
        }

        public PartialPurchasePayment(long id, double Amt, long paytype, long partyno)
        {
            InitializeComponent();
            ID = id;
            GrandTotal = Amt;
        ...
        private void PartialPayment_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                lblPayAmt.ForeColor = Color.Green;
        ...
        public void BindGridPayType(long ID)
        {
            try
            {
                ...
                dtPayLedger = ObjFunction.GetDataView("Select * From MPayTypeLedger Where PayTypeNo <=5 ").Table;//in (2,4,5)
                string sqlQuery = "";
                if (ID == 0)
                    sqlQuery = "SELECT PayTypeName, PKPayTypeNo, Cast(0.00 as varchar) AS Amount, 0 AS LedgerNo, 0 AS PKVoucherPayTypeNo,ControlUnder FROM MPayType Where PKPayTypeNo<=5   ORDER BY PKPayTypeNo";//in (2,4,5)
                else
                    sqlQuery = "SELECT PayTypeName, PKPayTypeNo,Cast( IsNull((SELECT SUM(Amount) FROM TVoucherPayTypeDetails WHERE (FKSalesVoucherNo = " + ID + ") AND PKPayTypeNo<=5  AND (FKPayTypeNo = PKPayTypeNo)),0) AS varchar) AS Amount, 0 AS LedgerNo, 0 AS PKVoucherPayTypeNo,ControlUnder FROM MPayType Where PKPayTypeNo <=5 ORDER BY PKPayTypeNo";//in (2,4,5)
        ...
        public void CaluculatePayType()
        {
            try
            {
                ...
                if (GrandTotal != 0)
                {
                    ...
                    lblPayAmt.Text = TotAmt.ToString("0.00");
                    lblPayTypeBal.Text = (GrandTotal - TotAmt).ToString("0.00");
                }
                else
                {
                    lblBillAmt.Text = GrandTotal.ToString("0.00");
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (dgPayChqDetails.Rows[0].Cells[0].Value == null || dgPayChqDetails.Rows[0].Cells[1].Value == null || dgPayChqDetails.Rows[0].Cells[2].Value == null || dgPayChqDetails.Rows[0].Cells[4].Value == null)
                    {
                ...
                if (flag == true)
                {
                    ...
                    {
                        if (dgPayCreditCardDetails.Rows[0].Cells[0].Value == null || dgPayCreditCardDetails.Rows[0].Cells[1].Value == null || dgPayCreditCardDetails.Rows[0].Cells[3].Value == null)
                        {
        ...
        public bool SaveData(long pk)
        {
            ...
            for (int i = 0; i < dgPayType.Rows.Count; i++)
            {
                if (Convert.ToDouble(dgPayType.Rows[i].Cells[2].Value) != 0)
                {
                    ...
                    tVoucherDetails.Debit = Convert.ToDouble(dgPayType.Rows[i].Cells[2].Value);//0;
                    tVoucherDetails.Credit = 0; //Convert.ToDouble(dgPayType.Rows[i].Cells[2].Value);
                    ...
                    if (Convert.ToInt64(dgPayType.Rows[i].Cells[5].Value) == 4)
                    {
                        ...
                        for (int row = 0; row < dr.Length; row++)
                        {
                            if (dr[row][0].ToString() != null && dr[row][0].ToString() != "")
                            {
                                ...
                                tVchChqCredit.BranchNo = 0;// Convert.ToInt64(dr[row][7].ToString());
                    ...
                    if (Convert.ToInt64(dgPayType.Rows[i].Cells[5].Value) == 5)
                    {
                        ...
                        for (int row = 0; row < dr.Length; row++)
                        {
                            if (dr[row][0].ToString() != null && dr[row][0].ToString() != "")
                            {
                                ...
                                tVchChqCredit.BranchNo = 0;// Convert.ToInt64(dr[row][6].ToString());
                    ...
                    tVoucherDetails.Debit = 0;//Convert.ToDouble(dgPayType.Rows[i].Cells[2].Value);
                    tVoucherDetails.Credit = Convert.ToDouble(dgPayType.Rows[i].Cells[2].Value);//0;
                    ...
                    else
                    {
                        ...
                        if (dgPayType.Rows[dgPayType.CurrentCell.RowIndex].Cells[5].Value.ToString() == "4")//dgPayType.CurrentCell.RowIndex == 3
                        {
                            ...
                            else
                            {
                                ...
                                pnlPartial.Size = new Size(775, 304);
            ...
            try
            {
                ...
                else if (e.KeyCode == Keys.D && e.Control)
                {
                    if (dgPayType.CurrentCell.RowIndex == 3)
                    {
                        if (Convert.ToDouble(dgPayType.Rows[dgPayType.CurrentCell.RowIndex].Cells[2].Value) > 0)
                        {
                            pnlPartial.Size = new Size(775, 323);
            ...
            try
            {
                ...
                else if (e.KeyCode == Keys.Escape)
                {
                    ...
                    if (dgPayChqDetails.Rows[0].Cells[0].Value != null)
                    {
                        ...
                        if (dgPayChqDetails.Rows[0].Cells[1].FormattedValue.ToString() == "" || dgPayChqDetails.Rows[0].Cells[2].FormattedValue.ToString() == "" || dgPayChqDetails.Rows[0].Cells[4].FormattedValue.ToString() == "")
                        {
                            OMMessageBox.Show("Please Fill Cheque Details.", CommonFunctions.ErrorTitle, OMMessageBoxButton.OK, OMMessageBoxIcon.Error);
                            return;
                        }
                        ...
                        btnOk.Enabled = true;
                            ...
                            if (PayType == 1)
                            {
                                pnlPartial.Size = new Size(305, 304);
        ...
        private void dgPayCreditCardDetails_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                else if (e.KeyCode == Keys.Escape)
                {
                    ...
                    {
                        if (dgPayCreditCardDetails.Rows[0].Cells[0].FormattedValue.ToString() == "" || dgPayCreditCardDetails.Rows[0].Cells[1].FormattedValue.ToString() == "" || dgPayCreditCardDetails.Rows[0].Cells[3].FormattedValue.ToString() == "")
                        {
                            OMMessageBox.Show("Please Fill Credit Card Details.", CommonFunctions.ErrorTitle, OMMessageBoxButton.OK, OMMessageBoxIcon.Error);
                            return;
                        }
