...
{
    public partial class SalesAutoReturnAE : Form
    {
        ...
        public SalesAutoReturnAE()
        {
            InitializeComponent();
        }

        public SalesAutoReturnAE(long ID)
        {
            InitializeComponent();
            this.ID = ID;
        }

        private void SalesAutoReturnAE_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dgBill.ColumnHeadersDefaultCellStyle.Font = new Font("Courier New", 9, FontStyle.Bold);
                dgBill.RowHeadersDefaultCellStyle.Font = new Font("Courier New", 10, FontStyle.Regular);
                dgBill.RowTemplate.DefaultCellStyle.Font = new Font("Courier New", 10, FontStyle.Regular);
                ...
                if (dgBill.Rows.Count > 0)
                {
                    ...
                    {
                        dgBill.Rows[i].DefaultCellStyle.Font = new Font("Courier New", 10, FontStyle.Regular);
      ...
      " MCity ON MLedgerDetails.CityNo = MCity.CityNo WHERE(DeliveryLedgerNo = " + PartyNo + ")";
        ...
        public void InitControls()
        {
            try
            {
                ...
                lstPaymentType.SelectedValue = 3;// Convert.ToInt64(ObjFunction.GetAppSettings(AppSettings.S_DefaultPayType));
     ...
     " TStock ON TVoucherDetails.PkVoucherTrnNo = TStock.FkVoucherTrnNo WHERE (TVoucherEntry.VoucherTypeCode = " + VoucherType + ") AND (TVoucherEntry.PkVoucherNo = " + LastBillNo + ")").Table;
        ...
        private void FillGrid()
        {
            try
            {
                ...
                if (State == true)
                {
                    // For automobiles in grid display testing code has been written 
                    // Original code is commented 


                    //" (Select case when len(substring(MItemGroup_1.ItemGroupName, 1, 10)) < 10 then  substring(MItemGroup_1.ItemGroupName, 1, 10) + ' ' + space(9 - len(substring(MItemGroup_1.ItemGroupName, 1, 10))) " +
                    // " when  len(substring(MItemGroup_1.ItemGroupName, 1, 10)) >= 10 then  substring(MItemGroup_1.ItemGroupName, 1, 10) end as test ) +'  ' +
                    //  "   (Select case when len(substring(MItemGroup.ItemGroupName, 1, 10)) < 10 then  substring(MItemGroup.ItemGroupName, 1, 10) + ' ' + space(9 - len(substring(MItemGroup.ItemGroupName, 1, 10))) " +
                    //   " when  len(substring(MItemGroup.ItemGroupName, 1, 10)) >= 10 then  substring(MItemGroup.ItemGroupName, 1, 10) end as test2 ) +'  ' +
                    //    " (Select case when len(substring(MItemGroup_2.ItemGroupName, 1, 10)) < 10 then substring(MItemGroup_2.ItemGroupName, 1, 10) + ' ' + space(9 - len(substring(MItemGroup_2.ItemGroupName, 1, 10))) " +
                    //   " when  len(substring(MItemGroup_2.ItemGroupName, 1, 10)) >= 10 then  substring(MItemGroup_2.ItemGroupName, 1, 10) end as test3 ) +'  ' + " +
                    //   " ItemName as Itemname , TStock.GRWeight as GrossWt , " +

                    //                    sqlQuery = "SELECT 0 AS Sr, TStock.DisplayItemName AS ItemName ," + /* (SELECT case when esflag='False' then ItemName+'*' else ItemName end as ItemName FROM dbo.MStockItems_V(NULL, TStock.ItemNo, NULL, NULL, NULL, NULL, NULL) AS MStockItems_V_1) AS ItemName,*/ " TStock.GRWeight as GrossWt ,TStock.TRWeight as TariffWt , TStock.Quantity,MUOM.UOMName, " +
                    //sqlQuery = "SELECT 0 AS Sr, substring(MItemGroup_1.ItemGroupName,1,5) + '  ' + substring(MItemGroup.ItemGroupName,1,4) +'  ' +  substring(MItemGroup_2.ItemGroupName,1,5) + '  ' + ItemName as Itemname ," + /* (SELECT case when esflag='False' then ItemName+'*' else ItemName end as ItemName FROM dbo.MStockItems_V(NULL, TStock.ItemNo, NULL, NULL, NULL, NULL, NULL) AS MStockItems_V_1) AS ItemName,*/ " TStock.GRWeight as GrossWt ,TStock.TRWeight as TariffWt , TStock.Quantity,MUOM.UOMName, " +
                    sqlQuery = "SELECT 0 AS Sr, (Select case when len(substring(MItemGroup_1.ItemGroupName, 1, 10)) < 10 then  substring(MItemGroup_1.ItemGroupName, 1, 10) + ' ' + space(9 - len(substring(MItemGroup_1.ItemGroupName, 1, 10))) " +
                    " when  len(substring(MItemGroup_1.ItemGroupName, 1, 10)) >= 10 then  substring(MItemGroup_1.ItemGroupName, 1, 10) end as test ) +'  ' + " +
                    "(Select case when len(substring(MItemGroup.ItemGroupName, 1, 10)) < 10 then  substring(MItemGroup.ItemGroupName, 1, 10) + ' ' + space(9 - len(substring(MItemGroup.ItemGroupName, 1, 10))) " +
                    " when  len(substring(MItemGroup.ItemGroupName, 1, 10)) >= 10 then  substring(MItemGroup.ItemGroupName, 1, 10) end as test2 ) +'  ' + " +
                    " (Select case when len(substring(MItemGroup_2.ItemGroupName, 1, 10)) < 10 then substring(MItemGroup_2.ItemGroupName, 1, 10) + ' ' + space(9 - len(substring(MItemGroup_2.ItemGroupName, 1, 10))) " +
                    " when  len(substring(MItemGroup_2.ItemGroupName, 1, 10)) >= 10 then  substring(MItemGroup_2.ItemGroupName, 1, 10) end as test3 ) +'  ' + " +
                    " ItemName as Itemname , TStock.GRWeight as GrossWt , TStock.TRWeight as TariffWt , TStock.Quantity,MUOM.UOMName, " +
                ...
                " MItemMaster.CompanyNo,  (ISNULL ((SELECT SchemeDetailsNo FROM TRewardTo WHERE (FkStockNo = TStock.PkStockTrnNo)), NULL)) AS 'SchemeDetailsNo', " +
                  ...
                  //       "left join  MItemTaxInfo  as MItemTaxInfo_3 ON TStock.FKAddItemTaxSettingNo = MItemTaxInfo_3.PkSrNo " +

                  " FROM         MItemTaxInfo AS MItemTaxInfo_3 RIGHT OUTER JOIN MItemGroup AS MItemGroup_1 INNER JOIN " +
            " MItemMaster INNER JOIN                      TStock ON MItemMaster.ItemNo = TStock.ItemNo INNER JOIN " +
            " TVoucherDetails ON TStock.FkVoucherTrnNo = TVoucherDetails.PkVoucherTrnNo INNER JOIN " +
            " MItemTaxInfo ON TStock.FkItemTaxInfo = MItemTaxInfo.PkSrNo LEFT OUTER JOIN " +
            " MItemTaxInfo AS MItemTaxInfo_2 ON TStock.FkItemTaxInfo2 = MItemTaxInfo_2.PkSrNo INNER JOIN " +
            " MUOM ON TStock.FkUomNo = MUOM.UOMNo INNER JOIN                      MRateSetting ON TStock.FkRateSettingNo = MRateSetting.PkSrNo INNER JOIN " +
            " MItemGroup AS MItemGroup_2 ON MItemMaster.FkCategoryNo = MItemGroup_2.ItemGroupNo INNER JOIN " +
            " MItemGroup ON MItemMaster.FkDepartmentNo = MItemGroup.ItemGroupNo ON MItemGroup_1.ItemGroupNo = MItemMaster.GroupNo LEFT OUTER JOIN " +
            " TOtherStockDetails ON TStock.PkStockTrnNo = TOtherStockDetails.FKStockTrnNo ON MItemTaxInfo_3.PkSrNo = TStock.FKAddItemTaxSettingNo " +
                ...
                {
                    sqlQuery = "SELECT 0 AS Sr, TStock.DisplayItemName AS ItemName," + /*(SELECT ItemName FROM dbo.MStockItems_V(NULL, TStock.ItemNo, NULL, NULL, NULL, NULL, NULL) AS MStockItems_V_1) AS ItemName, " +*/
        ...
        private void FillItemList(int qNo)
        {
            try
            {
                ...
                switch (strItemQuery.Length - qNo)
                {
                    case 0:
                        ItemList = ItemList.Replace("AS ItemName,", "AS ItemName,Case When(mitemmaster.LangShortDesc<>'') then mitemmaster.LangShortDesc else mitemmaster.LangFullDesc end AS ItemNameLang,");
                        ItemList = ItemList.Replace("dbo.GetItemRateAll(NULL, NULL, NULL, NULL,null)", " dbo.GetItemRateAllAuto(NULL, NULL, NULL, NULL,NULL," + lstGroup1.SelectedValue + "," + lstGroup2.SelectedValue + ") ");
                    ...
                    case 2:
                        if (!ItemList.Equals(strItemQuery_last[qNo - 1], StringComparison.CurrentCultureIgnoreCase))
                        {
                            ObjFunction.FillList(lstGroup2, ItemList.Trim());
                            strItemQuery_last[qNo - 1] = ItemList;
                        }
        ...
        //          //  if ((!ItemList.Equals(strItemQuery_last[qNo - 1], StringComparison.CurrentCultureIgnoreCase)))//==|| (IsRefresh == true)
        //            {
        //                IsRefresh = false;
        //                ItemList = ItemList.Replace("ORDER BY", "And MItemMaster.itemno in (select itemno from MItemTaxInfo where FromDate<='" + dtpBillDate.Text.Trim() + "' ) Order by ");
        ...
        private void dgItemList_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                ...
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    {
                        dgBill.CurrentRow.Cells[ColIndex.UOMNo].Value = Convert.ToInt64(dgItemList.Rows[dgItemList.CurrentCell.RowIndex].Cells["UOMDefault"].Value);
                        dgBill.CurrentRow.Cells[ColIndex.Rate].Value = dgBill.CurrentRow.Cells[ColIndex.TempRate].Value = Convert.ToDouble(dgItemList.Rows[dgItemList.CurrentCell.RowIndex].Cells["iRate"].Value).ToString("0.00");//lstRate.Text;
                        dgBill.CurrentRow.Cells[ColIndex.PkRateSettingNo].Value = Convert.ToInt64(dgItemList.Rows[dgItemList.CurrentCell.RowIndex].Cells["iRateSettingNo"].Value);//lstRate.SelectedValue;
                        dgBill.CurrentRow.Cells[ColIndex.UOM].Value = dgItemList.Rows[dgItemList.CurrentCell.RowIndex].Cells["iUOM"].Value;
                        dgBill.CurrentRow.Cells[ColIndex.MRP].Value = dgItemList.Rows[dgItemList.CurrentCell.RowIndex].Cells["iMRP"].Value;
                        dgBill.CurrentRow.Cells[ColIndex.DiscPercentage].Value = dgItemList.Rows[dgItemList.CurrentCell.RowIndex].Cells["PartyDiscPerce"].Value;
                        dgBill.CurrentRow.Cells[ColIndex.IsRateChange].Value = "0";
                        dgBill.CurrentRow.Cells[ColIndex.Barcode].Value = dgItemList.Rows[dgItemList.CurrentCell.RowIndex].Cells["iBarcode"].Value;
                        dgBill.CurrentRow.Cells[ColIndex.ESFlag].Value = Convert.ToBoolean(dgItemList.Rows[dgItemList.CurrentCell.RowIndex].Cells["ESFlag"].Value);
                        ...
                        string ItemnameStr = lstGroup2.Text + " -" + lstGroup1.Text + " -" + dgItemList.Rows[dgItemList.CurrentCell.RowIndex].Cells["iItemName"].Value;
                        dgBill.CurrentRow.Cells[ColIndex.ItemName].Value = ItemnameStr;
                        dgBill.CurrentRow.Cells[ColIndex.DisplayName].Value = ItemnameStr;
                        if (IsCancel == false)
                            dgBill.CurrentRow.Cells[ColIndex.PkStockTrnNo].Value = 0;
                        if (Convert.ToBoolean(ObjFunction.GetAppSettings(AppSettings.S_ShowSalesMan)) == true)
                        {
                        ...
                        IsCancel = false;
                        //  dgBill.Rows.Add();
                        dgBill.CurrentRow.ReadOnly = false;
                        dgBill.Focus();
                    }
                    pnlSalePurHistory.Visible = false;
                }
    ...
    " GROUP BY  MItemMaster.ItemNo,MItemMaster.Barcode, MRateSetting.MRP, MRateSetting.UOMNo,MItemMaster.esflag";
        ...
        private void Desc_MoveNext(long ItemNo, long BarcodeNo)
        {
            try
            {
                ...
                dgBill.Rows[dgBill.CurrentCell.RowIndex].Cells[ColIndex.StockCompanyNo].Value = DBGetVal.FirmNo;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tVoucherDetails.Credit = Convert.ToDouble(txtGrandTotal.Text); 
                ...
                if (DBGetVal.KachhaFirm == true)
                {
                    ...
                    if (Convert.ToDouble(txtRoundOff.Text) >= 0)
                    {
                        ...
                        tVoucherDetails.Debit = Convert.ToDouble(txtGrandTotal.Text) - Convert.ToDouble(txtRoundOff.Text);// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtRoundOff.Text)) / 10;
                    }
                    else
                    {
                        tVoucherDetails.Debit = Convert.ToDouble(txtGrandTotal.Text) + Convert.ToDouble(txtRoundOff.Text);// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Math.Abs(Convert.ToDouble(txtRoundOff.Text))) / 10;
                ...
                if (Convert.ToDouble(txtSchemeDisc.Text) != 0)
                {
                    ...
                    tVoucherDetails.Credit = Convert.ToDouble(txtSchemeDisc.Text);//(Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtSchemeDisc.Text)) / 10;
                    tVoucherDetails.Debit = 0;
                    tVoucherDetails.Narration = "";
                ...
                if (Convert.ToDouble(txtDiscRupees1.Text) != 0)
                {
                    ...
                    tVoucherDetails.Credit = Convert.ToDouble(txtDiscRupees1.Text);// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtDiscRupees1.Text)) / 10;
                    tVoucherDetails.Debit = 0;
                    tVoucherDetails.Narration = "";
                ...
                if (Convert.ToDouble(txtOtherDisc.Text) != 0)
                {
                    ...
                    tVoucherDetails.Credit = Convert.ToDouble(txtOtherDisc.Text);// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtOtherDisc.Text)) / 10;
                    tVoucherDetails.Debit = 0;
                    tVoucherDetails.Narration = "";
                ...
                if (Convert.ToDouble(txtChrgRupees1.Text) != 0)
                {
                    ...
                    tVoucherDetails.Credit = 0;
                    tVoucherDetails.Debit = Convert.ToDouble(txtChrgRupees1.Text);// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtChrgRupees1.Text)) / 10;
                    tVoucherDetails.Narration = "";
                ...
                if (Convert.ToDouble(txtChrgRupees2.Text) != 0)
                {
                    ...
                    tVoucherDetails.Credit = 0;
                    tVoucherDetails.Debit = Convert.ToDouble(txtChrgRupees2.Text);// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtChrgRupees1.Text)) / 10;
                    tVoucherDetails.Narration = "";
                ...
                if (Convert.ToDouble(txtRoundOff.Text) != 0)
                {
                    ...
                    if (Convert.ToDouble(txtRoundOff.Text) >= 0)
                    {
                        tVoucherDetails.SignCode = 2;
                        tVoucherDetails.Credit = 0;
                        tVoucherDetails.Debit = Math.Abs(Convert.ToDouble(txtRoundOff.Text));// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtRoundOff.Text)) / 10;
                    }
                    else
                    {
                        tVoucherDetails.SignCode = 1;
                        tVoucherDetails.Credit = Math.Abs(Convert.ToDouble(txtRoundOff.Text));// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Math.Abs(Convert.ToDouble(txtRoundOff.Text))) / 10;
                        tVoucherDetails.Debit = 0;
                    }
                    tVoucherDetails.Narration = "";
