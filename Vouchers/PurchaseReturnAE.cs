...
" GROUP BY  MItemMaster.ItemNo,MItemMaster.Barcode, MRateSetting.MRP, MRateSetting.UOMNo";
        ...
        public void ReverseStock()
        {
            for (int i = 0; i < dtTempStock.Rows.Count; i++)
            {
                if (Convert.ToInt64(dtTempStock.Rows[i].ItemArray[47].ToString()) == DBGetVal.FirmNo)//Convert.ToInt64(dtCompRatio.Rows[j].ItemArray[0].ToString())
                {
                    ...
                    mRatesetting.ESFlag = Convert.ToBoolean(dtTempStock.Rows[i].ItemArray[57].ToString());
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tVoucherDetails.Debit = Convert.ToDouble(lblGrandTotal.Text); //0;
                tVoucherDetails.Credit = 0;// Convert.ToDouble(lblGrandTotal.Text);
                ...
                if (DBGetVal.KachhaFirm == false)
                {
                    ...
                    for (int k = 0; k < dtSaleLedger.Rows.Count; k++)
                    {
                        ...
                        if (debit > 0)
                        {
                            ...
                            tVoucherDetails.Debit = 0;// debit;
                            tVoucherDetails.CompanyNo = Convert.ToInt64(dgBill.Rows[ledgerNo].Cells[ColIndex.StockCompanyNo].Value);
                            tVoucherDetails.Credit = debit;// 0;// (GetRatio(tVoucherDetails.CompanyNo) * debit) / 10;
                            tVoucherDetails.Narration = "";
                            dbTVoucherEntry.AddTVoucherDetails(tVoucherDetails);
                            debit = 0;
                        }
                ...
                if (Convert.ToDouble(txtSchemeDisc.Text) != 0)
                {
                    ...
                    tVoucherDetails.Debit = Convert.ToDouble(txtSchemeDisc.Text); //0;//(Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtSchemeDisc.Text)) / 10;
                    tVoucherDetails.Credit = 0;// Convert.ToDouble(txtSchemeDisc.Text);
                    tVoucherDetails.Narration = "";
                ...
                if (Convert.ToDouble(txtDiscRupees1.Text) != 0)
                {
                    ...
                    tVoucherDetails.SignCode = 1;
                    tVoucherDetails.LedgerNo = Convert.ToInt64(ObjFunction.GetAppSettings(AppSettings.P_Discount1));
                    tVoucherDetails.Debit = Convert.ToDouble(txtDiscRupees1.Text); //0;// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtDiscRupees1.Text)) / 10;
                ...
                if (Convert.ToDouble(txtOtherDisc.Text) != 0)
                {
                    ...
                    tVoucherDetails.SignCode = 1;
                    tVoucherDetails.LedgerNo = Convert.ToInt64(ObjFunction.GetAppSettings(AppSettings.P_Discount1));
                    tVoucherDetails.Debit = Convert.ToDouble(txtOtherDisc.Text); //0;// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtOtherDisc.Text)) / 10;
                    tVoucherDetails.Credit = 0;// Convert.ToDouble(txtOtherDisc.Text);
                    tVoucherDetails.Narration = "";
                ...
                if (Convert.ToDouble(txtChrgOnTaxAmt.Text) != 0)
                {
                    ...
                    tVoucherDetails.Debit = 0;// Convert.ToDouble(txtChrgOnTaxAmt.Text);
                    tVoucherDetails.Credit = Convert.ToDouble(txtChrgOnTaxAmt.Text);// 0;// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtChrgRupees1.Text)) / 10;
                    tVoucherDetails.Narration = "";
                ...
                if (Convert.ToDouble(txtChrgOnTaxAmt.Text) != 0)
                {
                    ...
                    tVoucherDetails.SignCode = 2;
                    tVoucherDetails.LedgerNo = Convert.ToInt64(ObjFunction.GetAppSettings(AppSettings.P_Charges1));
                    tVoucherDetails.Debit = 0;// Convert.ToDouble(ChargeTaxAmt);
                    tVoucherDetails.Credit = Convert.ToDouble(ChargeTaxAmt); //0;// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtChrgRupees1.Text)) / 10;
                    tVoucherDetails.Narration = "";
                ...
                if (Convert.ToDouble(txtChrgRupees2.Text) != 0)
                {
                    ...
                    tVoucherDetails.Debit = 0;// Convert.ToDouble(txtChrgRupees2.Text);
                    tVoucherDetails.Credit = Convert.ToDouble(txtChrgRupees2.Text); //0;// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtChrgRupees1.Text)) / 10;
                    tVoucherDetails.Narration = "";
                ...
                if (Convert.ToDouble(txtRoundOff.Text) != 0)
                {
                    ...
                    if (Convert.ToDouble(txtRoundOff.Text) >= 0)
                    {
                        ...
                        tVoucherDetails.Credit = Convert.ToDouble(txtRoundOff.Text);// 0;// (Convert.ToDouble(dtCompRatio.Rows[i].ItemArray[1].ToString()) * Convert.ToDouble(txtRoundOff.Text)) / 10;
                    }
                    else
                    {
                        tVoucherDetails.SignCode = 1;
