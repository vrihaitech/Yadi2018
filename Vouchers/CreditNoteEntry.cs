...
{
    public partial class CreditNoteEntry : Form
    {

        CommonFunctions ObjFunction = new CommonFunctions();
        DBTVaucherEntry dbTVoucherEntry = new DBTVaucherEntry();
        public static long RequestCreditNo, VType;

        public CreditNoteEntry()
        {
            InitializeComponent();
            VType = VchType.CreditNote;
            this.Text = "Credit Note(Search)";
            this.Name = "Credit Note(Search)";
        ...
        {
            RequestCreditNo = Convert.ToInt32(DataGridView1.SelectedRows[0].Cells[0].Value);
            Form NewF = null;
            NewF = new CreditNoteEntryAE();
            this.Close();
        ...
        {
            RequestCreditNo = 0;
            Form NewF = new CreditNoteEntryAE();
            this.Close();
            ObjFunction.OpenForm(NewF, DBGetVal.MainForm);
        }
